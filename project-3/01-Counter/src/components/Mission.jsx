...
// This is your Card9 component
const Card9 = ({username}) => { // agar props mai koi value pass nahi hui hai to default hota hai jo aap asign hoti hai 
...
// This is the outer Card component that renders Card9
const Mission = () => {
  return (
    <div>
      <Card9 />
